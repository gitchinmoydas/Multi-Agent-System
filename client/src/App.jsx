...
function App() {
  ...
  const handleResearch = async (e) => {
    ...
    const loadingToast = toast.loading('🔍 Researching... This may take a few minutes', {
      duration: Infinity
    })
    ...
    try {
      ...
      header.innerHTML = `
        <div style="text-align: center; margin-bottom: 30px; padding: 20px; border-bottom: 2px solid #3b82f6;">
          <h1 style="color: #1e40af; margin-bottom: 10px;">AI Research Report</h1>
          <p style="color: #6b7280;">Generated on ${new Date().toLocaleString()}</p>
          <p style="color: #3b82f6; font-weight: bold;">Topic: ${topic}</p>
        </div>
      `
      ...
      footer.innerHTML = `
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; font-size: 12px; color: #9ca3af;">
          <p>AI Research Assistant - Professional Research Report</p>
        </div>
      `
  ...
  const MarkdownComponents = {
    h1: ({ node, ...props }) => (
      <h1 className="text-3xl font-bold mt-8 mb-4 pb-2 border-b-2 border-blue-500 text-gray-900" {...props} />
    ),
    h2: ({ node, ...props }) => (
    ...
    blockquote: ({ node, ...props }) => (
      <blockquote className="border-l-4 border-blue-400 pl-4 py-2 my-4 bg-blue-50 rounded-r-lg text-gray-700 italic" {...props} />
    ),
    code: ({ node, inline, className, children, ...props }) => {
      ...
      return !inline && match ? (
        ...
        <code className="bg-gray-100 rounded px-1.5 py-0.5 text-sm font-mono text-red-600" {...props}>
          {children}
        </code>
      )
    },
  ...
  const Section = ({ title, icon: Icon, section, children, color = 'blue', badge }) => {
    const colors = {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Intelligent research pipeline with search, scraping, and analysis</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <form onSubmit={handleResearch}>
              ...
              <div className="flex gap-3 flex-wrap">
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-2 rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-md"
                >
                  {loading ? (
                    <>
                ...
                {research && research.report && research.report !== 'No data available' && (
                  <>
                    <button
                      type="button"
                      onClick={() => handleDownload(research.report, `${getReportTitle()}.md`)}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      A comprehensive analysis has been completed. The full report includes detailed findings, 
        ...
        {loading && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Conducting Research</h3>
      ...
      <footer className="border-t border-gray-200 mt-12 py-6 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm text-gray-500">
          <p>Powered by AI • Intelligent Search • Web Scraping • Automated Analysis • Professional Reporting</p>
        </div>
      </footer>
